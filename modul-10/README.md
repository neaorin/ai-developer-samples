...
Operaționalizare și evaluare pentru aplicații LLM
...
- asigurați-vă că sunteți în directorul `modul-10`:
...
Continuați cu primul exemplu din acest laborator, `01-demo-azure-ai-search-build-index.py`

```
python 01-demo-azure-ai-search-build-index.py
```