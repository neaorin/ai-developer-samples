# Exercise 01: Azure OpenAI Function calling
# Modifica acest fisier pentru a face chatbot-ul sa caute pe internet inainte sa raspunda la intrebari
# Defineste o functie in acest scop
# Pentru implementarea ei poti folosi functions/web_search.py:
# from functions.web_search import web_search
# web_search("Who won Euro 2024?")
